<template>
  <a href="/feed.xml">
    <svg
      ...
      class="group"
    >
      <title>Ausbaufähig RSS Feed</title>
      <desc>RSS Icon that links to the Ausbaufähig RSS feed (XML)</desc>
      <path
        class="fill-white group-hover:fill-teal-dark"
        d="M145.659,0c80.44,0,145.66,65.219,145.66,145.66c0,80.45-65.219,145.659-145.66,145.659
        S0,226.109,0,145.66C0,65.219,65.21,0,145.659,0z"
      />
      <path
        class="fill-teal-dark group-hover:fill-white"
        d="M109.254,163.831c-10.06,0-18.226,8.157-18.226,18.226s8.157,18.226,18.226,18.226
